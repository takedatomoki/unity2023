namespace OpenCvSharp.Demo
{
	...
	/// 派生クラスでオーバーライド（基底クラスのメソッドを上書きする）して使ってね（継承用のコード）
	/// </summary>
	
	///  抽象クラスの定義　派生クラスで実装する
	public abstract class webcam_on: MonoBehaviour
	{
		/// <summary>
		...
		/// カメラデバイス名を取得する　
		/// string型　文字列を扱う　返り値がstring型のメソッド
		/// </summary>
		/// DeviceNameプロパティ
